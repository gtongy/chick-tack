...
成長速度の早い SaaS はどの様な戦略を取ってきたのかを潜り、知見として溜まるといいなと思いコンテキストへ落とし込む。
...
2015 年 9 月まで、特定の病院での仕事で怪我をしたテキサスの看護師は、頼りになるものが限られていた。  
-why-> テキサス州法があいまいな言葉で書かれたものしかない。  
-why-> 2003 年の医療過誤および不法行為改革法は、病院の雇用主に対するこれらの看護師の主張を医療過誤訴訟と同じカテゴリーにまとめた。

ここから、ケイツ氏が求められていた事項は、看護師が仕事で負傷したときに補償を求めることを可能にする法案の可決を支援だった。  
この法案を擁護するために、以前は Excel を使って連絡先リストを使っていた。  
これに対して Airtable を使うことで、顔と名前が画面で一目でわかることに良さがある。

![](https://gyazo.com/fe83060551e479c4153bb2de668f5f4f/raw)
これによって、人と顔の一致が即座に認識出来ることに良さを感じて利用してもらっている。  
また、ケイツ氏は擁護に対しての情熱で本を実費出版を行う。  
...
email での運用を進めていると、例えば email に.cc をつけて運用するような運用をもししていた場合に、メールそのものが埋もれてしまったり、そのメールに対してどのくらい重要なメールなのかがわかりづらくなる。この痛みを解決する。

![](https://gyazo.com/bf791eb3b44c86ca1bfce6de8c5bc892/raw)

現在、拡張できるアプリ数も 50 件以上あるため、個人で手持ちのタスクが大量に持ち始めて誰がどの情報を持っているのかが乱立するような場合にチーム間で流れやすいコンテキストの共有を一元で管理できることに超特化。
...
このように、**チーム間でのメールコミュニケーションを効率化させながら、かつタグや自動化アクション等を利用することによりフォルダ管理では実現出来なかったメールの進捗管理の側面を取り入れたこと**がサービスとしてレベルが一つ上だと感じる。  

## 終わりに

今回は2つの大型調達を行っているSaaSの肩からサービスの成長を眺めながら、両方のSaaSの成長の過程でどんなユーザーのニーズが発生したのか、またどんな機能が発生したのかを眺めた。  
どちらのサービスも入り口として、既存の価値を守りつつ既存のサービス内で解決がなかなか難しいであろうユーザーのニーズを汲み取り新しい価値へ変換させていることがひしひしと感じる。  
